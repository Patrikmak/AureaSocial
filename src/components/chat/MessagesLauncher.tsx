...
export default function MessagesLauncher({ avatars }: MessagesLauncherProps) {
  ...
  return (
    <>
      ...
      <ChatFloatingButton unreadCount={unreadCount} avatars={resolvedAvatars} openMessages={() => setOpen(true)} />
    </>
  );
}